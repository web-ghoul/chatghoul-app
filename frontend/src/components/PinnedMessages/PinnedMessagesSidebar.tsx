...
const PinnedMessagesSidebar = ({ room, onClose }: PinnedMessagesSidebarProps) => {
                    ...
                    pinnedMessages.map((pm: any) => (
                        ...
                        >
                            ...
                            <div className="mt-2 px-2 flex justify-between items-center text-[10px] text-txt/40">
                                ...
                                {pm.expiresAt && <span>Expires {new Date(pm.expiresAt).toLocaleDateString()}</span>}
                            </div>
                        </div>
                    )).reverse()
                )}
