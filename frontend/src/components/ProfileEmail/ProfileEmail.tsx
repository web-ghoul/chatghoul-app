            ...
            {isEditing ? (
                <div className="flex items-center gap-3 border-b border-primary py-1">
                    ...
                    <div className="flex gap-2">
                        <div onClick={() => { setEmail(user?.email || ""); setIsEditing(false); }}>
                ...
                <div className="flex justify-between items-center gap-3">
                    <div className="flex justify-start items-center gap-3">
                        <Mail className="text-txt w-5 h-5 font-bold" />
                        <h6 className="text-white font-medium">{user?.email || "No email set"}</h6>
                    </div>
                    <div className="opacity-0 group-hover:opacity-100 transition-opacity">
                        <div onClick={() => setIsEditing(true)}>
                            <EditIcon
                                className="text-txt w-9 h-auto cursor-pointer p-2"
                            />
                        </div>
                    </div>
                </div>
